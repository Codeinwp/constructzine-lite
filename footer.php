	...
	<div class="inner cf">
		<div class="about-us">
			...
			if ( get_theme_mod( 'ti_footer_aboutus_title',__( 'About us','constructzine-lite' ) ) ) {
				echo '<h3>' . esc_attr( get_theme_mod( 'ti_footer_aboutus_title' ) ) . '</h3>';
			}
			?>
			<?php
		...
		<div class="contact-us">
			...
			if ( get_theme_mod( 'ti_footer_contactus_title','Contact us' ) ) {
				echo '<h3>' . esc_attr( get_theme_mod( 'ti_footer_contactus_title','Contact us' ) ) . '</h3>';
			}
		...
		<div class="directions">
			...
			if ( get_theme_mod( 'ti_footer_map_title','Map' ) ) {
				echo '<h3>' . esc_attr( get_theme_mod( 'ti_footer_map_title','Map' ) ) . '</h3>';
			}
			...
			<div class="constructzine-lite-copyright">
				<a href="https://themeisle.com/themes/constructzine-lite/" target="_blank" rel="nofollow">Constructzine Lite </a><?php _e( 'powered by','constructzine-lite' ); ?><a href="https://themeisle.com/themes/constructzine-lite/" target="_blank" rel="nofollow">WordPress</a>
			</div>
