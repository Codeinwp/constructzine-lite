...
$ti_frontpage_testimonials = get_theme_mod( 'ti_frontpage_article_testimonials' );
...
<div id="main-content">
	...
	<div class="inner cf">
			...
			<div class="box3">
				...
				<h3 class="block-title">
					...
					if ( get_theme_mod( 'ti_frontpage_boxone_title', 'Phasellus tempus' ) ) {
						...
						echo esc_attr( get_theme_mod( 'ti_frontpage_boxone_title', 'Phasellus tempus' ) );
				...
				if ( get_theme_mod( 'ti_frontpage_boxone_content', 'Vestibulum vel dapibus lectus, eu vulputate risus. Sed egestas varius tellus, eget auctor lacus semper nec. Nam mi felis, pellentesque eget tincidunt accumsan.' ) ) {
					...
					echo '<p>' . esc_attr( get_theme_mod( 'ti_frontpage_boxone_content', 'Vestibulum vel dapibus lectus, eu vulputate risus. Sed egestas varius tellus, eget auctor lacus semper nec. Nam mi felis, pellentesque eget tincidunt accumsan.' ) ) . '</p>';
			...
			<div class="box3">
				...
				<h3 class="block-title">
					...
					if ( get_theme_mod( 'ti_frontpage_boxtwo_title', 'Phasellus tempus' ) ) {
						...
						echo esc_attr( get_theme_mod( 'ti_frontpage_boxtwo_title', 'Phasellus tempus' ) );
				...
				if ( get_theme_mod( 'ti_frontpage_boxtwo_content', 'Vestibulum vel dapibus lectus, eu vulputate risus. Sed egestas varius tellus, eget auctor lacus semper nec. Nam mi felis, pellentesque eget tincidunt accumsan.' ) ) {
					...
					echo '<p>' . esc_attr( get_theme_mod( 'ti_frontpage_boxtwo_content', 'Vestibulum vel dapibus lectus, eu vulputate risus. Sed egestas varius tellus, eget auctor lacus semper nec. Nam mi felis, pellentesque eget tincidunt accumsan.' ) ) . '</p>';
			...
			<div class="box3">
				...
				<h3 class="block-title">
					...
					if ( get_theme_mod( 'ti_frontpage_boxthree_title', 'Phasellus tempus' ) ) {
						...
						echo esc_attr( get_theme_mod( 'ti_frontpage_boxthree_title', 'Phasellus tempus' ) );
				...
				if ( get_theme_mod( 'ti_frontpage_boxthree_content', 'Vestibulum vel dapibus lectus, eu vulputate risus. Sed egestas varius tellus, eget auctor lacus semper nec. Nam mi felis, pellentesque eget tincidunt accumsan.' ) ) {
					...
					echo '<p>' . esc_attr( get_theme_mod( 'ti_frontpage_boxthree_content', 'Vestibulum vel dapibus lectus, eu vulputate risus. Sed egestas varius tellus, eget auctor lacus semper nec. Nam mi felis, pellentesque eget tincidunt accumsan.' ) ) . '</p>';
		...
		<?php if ( isset( $ti_frontpage_testimonials ) && $ti_frontpage_testimonials != 1 ) : ?>

		<article class="front">

			<?php else : ?>

			<article class="front front-full-page">
				...
				<h2 class="first-title">
					...
					if ( get_theme_mod( 'ti_frontpage_article_title', 'About us' ) ) {
						...
						echo esc_attr( get_theme_mod( 'ti_frontpage_article_title', 'About us' ) );
				...
				if ( get_theme_mod( 'ti_frontpage_article_image', get_template_directory_uri() . '/images/about_us.jpg' ) ) {
					...
					<img src="<?php echo esc_url( get_theme_mod( 'ti_frontpage_article_image', get_template_directory_uri() . '/images/about_us.jpg' ) ); ?>"
						 alt="<?php echo esc_attr( get_theme_mod( 'ti_frontpage_article_title', 'About us' ) ); ?>"
						 title="<?php echo esc_attr( get_theme_mod( 'ti_frontpage_article_title', 'About us' ) ); ?>">
			...
			<?php
			if ( isset( $ti_frontpage_testimonials ) && $ti_frontpage_testimonials != 1 ) :
				?>
